...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gb46uvk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gb46uvk.containers.anotherwebservice.com/
...
```
git clone git@github.com:Concainit11/container-gb46uvk.git
cd container-gb46uvk
```
...
```
docker attach container-gb46uvk
```
